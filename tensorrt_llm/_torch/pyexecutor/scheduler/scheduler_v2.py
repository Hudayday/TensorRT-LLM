...
class KVCacheV2Scheduler(RequestScheduler):
    ...
    def schedule_request(
        ...
        (
            ...
            disagg_candidates,
            has_chunking,
        ) = self._schedule_loop(active_requests, inflight_request_ids, pending_update_request_ids)
    ...
    def _schedule_loop(self, active_requests, inflight_request_ids, pending_update_request_ids):
    ...
    def _try_schedule_generation(
        ...
        *tokens* is meaningful only when *action* is ``SCHEDULED``.
        ...
        if success:
            return (ScheduleAction.SCHEDULED, req_tokens, scheduled_beam_width, req_it_end, False)
