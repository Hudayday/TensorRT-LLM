...
//
// On construction, reserves a size-granular, address-aligned byte range and waits for reused ranges.
// On destruction, retires the range with one completion event.
// ---------------------------------------------------------------------------
class StagingBuffer
{
public:
...
public:
    ...
    StagingBufferMemory memory() const noexcept;
