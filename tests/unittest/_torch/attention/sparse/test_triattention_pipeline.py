...
class TestFactory:
    ...
    def test_raises_type_error_for_non_v2_cache_mgr(self, dummy_calibration_pt):
    ...
    def test_returns_triattention_instance_with_v2(self, dummy_calibration_pt):
        ...
        # Pattern 3: the base __init__ asserts the *declared* subclass
        # (TriAttentionKVCacheManagerV2), so the stub must be that subclass,
        # mirroring production where get_kv_cache_manager_cls returns it.
